...
{\centering \includegraphics{figures/nw_dist_test.pdf}
...
{\centering \includegraphics{figures/paper3_flowchart_blue.pdf}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0700}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.6500}}@{}}
\caption{\label{tbl-features}All extracted features grouped by
...
\hypertarget{tbl-hyperparameters}{}
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2000}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2000}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.4000}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.2000}}@{}}
\caption{\label{tbl-hyperparameters}Details of the hyperparameters tuned
for each machine learning model, their descriptions, and the specific
range from which values were sampled during grid search
...
\bottomrule\noalign{}
\endlastfoot
Logistic Regression & Regularization Strength & Controls magnitude of
regularization penalty & {[}-10, 0{]} (log scale) \\
& Lasso Proportion & Mix between Ridge (0) and Lasso (1) regularization
& {[}0, 1{]} \\
Decision Tree & Cost Complexity & Controls the trade-off between tree's
depth and fit & {[}-10, -1{]} (log scale) \\
& Tree Depth & Maximum depth of the tree & {[}3, 7{]} \\
& Minimal Node Size & Minimum number of samples required to split a node
& {[}2, 40{]} \\
Multi-layer Perceptron & Hidden Units & Number of units in the hidden
layer(s) & {[}1, 10{]} \\
& Regularization Strength & Controls magnitude of regularization penalty
& {[}-10, 0{]} (log scale) \\
& Number of Epochs & Number of complete passes through the dataset &
{[}10, 1000{]} \\
XGBoost & Learning Rate & Step size shrinkage to prevent overfitting &
{[}-10, -1{]} (log scale) \\
& Minimum Loss Reduction & Minimum loss reduction required for partition
& {[}-10, 1.5{]} (log scale) \\
& Minimal Node Size & Minimum number of samples required to split a node
& {[}2, 40{]} \\
& Observations Sampled & Proportion of samples used per iteration &
{[}0.5, 1{]} \\
...
al.\textsuperscript{\protect\hyperlink{ref-chawla_smote_2002}{169}},
mitigates biases during model training that arise when models are skewed
towards the majority class. Using the themis R
package\textsuperscript{\protect\hyperlink{ref-themis}{170}}, we
...
\leavevmode\vadjust pre{\hypertarget{ref-piercy_physical_2018}{}}%
\CSLLeftMargin{6. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-Sundhedsstyrelsen2023_voksne}{}}%
\CSLLeftMargin{7. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-Sundhedsstyrelsen2023_unge}{}}%
\CSLLeftMargin{8. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-watson_2015}{}}%
\CSLLeftMargin{11. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-borazio_2014}{}}%
\CSLLeftMargin{81. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-difrancesco_sleep_2019}{}}%
\CSLLeftMargin{83. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-jones_2019}{}}%
\CSLLeftMargin{84. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-koopman-verhoeff_2019}{}}%
\CSLLeftMargin{85. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-huxe4usler_2020}{}}%
\CSLLeftMargin{86. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-migueles_ggir_2019}{}}%
\CSLLeftMargin{102. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-trevenen_2019}{}}%
\CSLLeftMargin{103. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-matthews_2002}{}}%
\CSLLeftMargin{107. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-king_2011}{}}%
\CSLLeftMargin{108. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-mn_non-wear_2020}{}}%
\CSLLeftMargin{152. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-sagelv_2019}{}}%
\CSLLeftMargin{156. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-lewy_1980}{}}%
\CSLLeftMargin{159. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-dozydave2023snooze}{}}%
\CSLLeftMargin{178. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-hees_2014}{}}%
\CSLLeftMargin{182. }%
\CSLRightInline{Hees, V. T. van \emph{et al.}
...
\leavevmode\vadjust pre{\hypertarget{ref-burazeri_2003}{}}%
\CSLLeftMargin{183. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-makino_2018}{}}%
\CSLLeftMargin{184. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-pastor-pellicer_2013}{}}%
\CSLLeftMargin{185. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-oyebode_2023}{}}%
\CSLLeftMargin{186. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-mukherjee_2015}{}}%
\CSLLeftMargin{187. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-quante_2018}{}}%
\CSLLeftMargin{188. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-cassidy_2016}{}}%
\CSLLeftMargin{189. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-espiritu_2008}{}}%
\CSLLeftMargin{190. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-altaf_2017}{}}%
\CSLLeftMargin{191. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-heinzer_2015}{}}%
\CSLLeftMargin{192. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-chen_2015}{}}%
\CSLLeftMargin{194. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-rentz_2021}{}}%
\CSLLeftMargin{196. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-altini_2021}{}}%
\CSLLeftMargin{197. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-herzig_2018}{}}%
\CSLLeftMargin{198. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-chouchou_2014}{}}%
\CSLLeftMargin{199. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-long_2017}{}}%
\CSLLeftMargin{200. }%
...
\leavevmode\vadjust pre{\hypertarget{ref-muzet_2016}{}}%
\CSLLeftMargin{201. }%
